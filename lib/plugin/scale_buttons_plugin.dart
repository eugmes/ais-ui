...
class ZoomButtonsPluginOptions extends LayerOptions {
  final int minZoom;
  final int maxZoom;
  final bool mini;
...
class ZoomButtonsPlugin implements MapPlugin {
  ...
  Widget createLayer(
    ...
    if (options is ZoomButtonsPluginOptions) {
  ...
  bool supportsLayer(LayerOptions options) {
    return options is ZoomButtonsPluginOptions;
  }
}

class ZoomButtons extends StatelessWidget {
  final ZoomButtonsPluginOptions zoomButtonsOpts;
  final MapState map;
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                ...
                if (zoom > zoomButtonsOpts.maxZoom) {
                  zoom = zoomButtonsOpts.maxZoom.toDouble();
                } else {
